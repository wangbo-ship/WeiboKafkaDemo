 ...
 * @date 2023/1/6 17:34
 */
public class EqualFilterOperation implements FilterOperation {
    ...
    public EqualFilterOperation() {
    }

    public EqualFilterOperation(Map<String, Object> parameters) {
    ...
    public BooleanNode eval(Object obj) {
        ...
        return ExprUtils.equal(leftNode.eval(obj),rightNode.eval(obj),targetFieldName);
    }
