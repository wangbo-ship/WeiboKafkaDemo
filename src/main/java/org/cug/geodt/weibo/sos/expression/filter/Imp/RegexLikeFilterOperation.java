 ...
 * @date 2023/1/9 12:40
 */
public class RegexLikeFilterOperation implements FilterOperation {
    ExprNode leftNode;
    ...
    public RegexLikeFilterOperation() {
    }

    public RegexLikeFilterOperation(Map<String, Object> parameters) {
    ...
    public BooleanNode eval(Object obj) {
        ...
        //想要查询的指定值
        this.rightNode = new GenericValueNode(referValue.getValue());
        ...
        //数据库中的值
        this.leftNode = new GenericValueNode(value);
        return ExprUtils.regexLike(leftNode.eval(obj),rightNode.eval(obj),targetFieldName);
    }
}
