 ...
 * @date 2023/1/9 12:03
 */
public class LtFilterOperation implements FilterOperation {
    ExprNode leftNode;
    ...
    public LtFilterOperation() {
    }

    public LtFilterOperation(Map<String, Object> parameters) {
    ...
    public BooleanNode eval(Object obj) {
        ...
        return ExprUtils.lt(leftNode.eval(obj),rightNode.eval(obj),targetFieldName);
    }
}
