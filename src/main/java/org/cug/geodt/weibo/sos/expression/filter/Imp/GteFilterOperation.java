 ...
 * @date 2023/1/8 18:06
 */
public class GteFilterOperation implements FilterOperation {
    ...
    public GteFilterOperation() {
    }

    public GteFilterOperation(Map<String, Object> parameters) {
    ...
    public BooleanNode eval(Object obj) {
        ...
        return ExprUtils.gte(leftNode.eval(obj),rightNode.eval(obj),targetFieldName);
    }
}
