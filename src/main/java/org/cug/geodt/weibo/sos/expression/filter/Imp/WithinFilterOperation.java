 ...
 */
public class WithinFilterOperation implements FilterOperation {
    ...
    public WithinFilterOperation() {
    }

    public WithinFilterOperation(Map<String, Object> parameters) {
    ...
    public BooleanNode eval(Object obj) {
        ...
        return ExprUtils.within(this.leftNode.eval(obj),rightNode.eval(obj),targetFieldName);
    }
}
