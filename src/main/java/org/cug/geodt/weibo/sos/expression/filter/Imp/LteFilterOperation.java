 ...
 * @date 2023/1/9 12:00
 */
public class LteFilterOperation implements FilterOperation {
    ...
    public LteFilterOperation() {
    }

    public LteFilterOperation(Map<String, Object> parameters) {
    ...
    public BooleanNode eval(Object obj) {
        ...
        return ExprUtils.lte(leftNode.eval(obj),rightNode.eval(obj),targetFieldName);
    }
}
